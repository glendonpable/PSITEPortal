 ...
 */
public class OverrideAdapter extends RecyclerView.Adapter<OverrideAdapter.OverrideViewHolder> {
    ...
    public OverrideAdapter(Context context, List<Nominee> nominees){
    ...
    @Override
    public void onBindViewHolder(OverrideViewHolder holder, final int position) {
...
//        });
    ...
    @Override
    public OverrideViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        View itemView = inflater.
                inflate(R.layout.override_content, viewGroup, false);
        ...
        return new OverrideViewHolder(itemView, context, mNominees);
    }

    public static class OverrideViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        Context context;
        public OverrideViewHolder(View v, Context context, List<Nominee> nominees) {
            super(v);
            this.nominees = nominees;
            this.context = context;
            v.setOnClickListener(this);
            //pic = (ImageView) v.findViewById(R.id.pic);
            name = (TextView) v.findViewById(R.id.override_name);
            institution = (TextView) v.findViewById(R.id.override_institution);
            thumbNail = (CircleImageView) v.findViewById(R.id.override_pic);
            checkbox = (CheckBox) v.findViewById(R.id.override_checkbox);
        }
...
//            thumbNail.setImageUrl(n.getImageUrl(), imageLoader);
            Glide.with(context).load(n.getImageUrl()).into(thumbNail);
            name.setText(n.getName());
            institution.setText(n.getInstitution());
            checkbox.setChecked(n.isSelected());
            checkbox.setTag(n);
            ...
            checkbox.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    //nom.setSelected(ch.isChecked());
                    try {
                            nom.setSelected(cb.isChecked());
//                            nomi.add(nom.getName());
                            Log.wtf("position is here", String.valueOf(nom.getName()));
            ...
            });//AppController.getInstance().setNominee(nomi);
        }
...
//            byte[] bytes = stream.toByteArray();
            ...
            AppController.getInstance().setActivity("nomination");
