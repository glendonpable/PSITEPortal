...
//        holder.bind(n);
    ...
    public NominationViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        return new NominationViewHolder(itemView, context, mNominees);
    }
...
//        public NetworkImageView thumbNail;
        ...
        public NominationViewHolder(View v, Context context, List<Nominee> nominees) {
            ...
            thumbNail = (CircleImageView) v.findViewById(R.id.nomination_pic);
                ...
                public void onClick(View view) {
                    ...
                    try {
                        ...
                        if (counter > num_positions_needed) {
                            cb.setChecked(false);
                            counter--;
                            Toast.makeText(context, "You are only allowed to nominate " + num_positions_needed + " nominee/s", Toast.LENGTH_SHORT).show();
                        } else {
