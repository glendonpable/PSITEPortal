 ...
 */
public class OverrideActivityAdd extends AppCompatActivity implements SearchView.OnQueryTextListener{
    ...
    private static String get_list_for_override_add = "get_list_for_override_add.php";
    private static String override_add = "override_add.php";
...
//        setHasOptionsMenu(true);
        ...
        getSupportActionBar().setTitle("Override Nomination - Add");
        ...
        LinearLayoutManager llm = new LinearLayoutManager(OverrideActivityAdd.this);
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog alertDialog = new AlertDialog.Builder(OverrideActivityAdd.this).create();
...
//    }
    ...
    private void insertData(/*final String username*/final ArrayList<String> add_username, final ArrayList<String> remove_username){
        RequestQueue queue = Volley.newRequestQueue(OverrideActivityAdd.this);
        StringRequest sr = new StringRequest(Request.Method.POST, Config.ROOT_URL + Config.WEB_SERVICES + override_add, new Response.Listener<String>() {
            @Override
            public void onResponse(String s) {
                Log.d("response", s.substring(0));
                Toast.makeText(OverrideActivityAdd.this,"Successfully saved changes", Toast.LENGTH_SHORT).show();
            }
        }, new Response.ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError volleyError) {
                Toast.makeText(OverrideActivityAdd.this, "There's something wrong with your connection, try again later.", Toast.LENGTH_SHORT).show();
            }
        }) {
            @Override
...
//    }
    ...
    public void getData(){
        ...
        RequestQueue queue = Volley.newRequestQueue(OverrideActivityAdd.this);
        StringRequest sr = new StringRequest(Request.Method.POST, Config.ROOT_URL + Config.WEB_SERVICES + get_list_for_override_add,
                        ...
                        try {
                            ...
                            for(int i = 0; i < jsonArray.length(); i++) {
                                ...
                                if(jsonObject.getString("success").equals("0")){
                                    ...
                                    if (Integer.parseInt(is_auto_added) == 1) {
                                        checked = true;
                                    } else if (Integer.parseInt(is_auto_added) == 0) {
                                        checked = false;
                                    }
                            ...
                            adapter = new OverrideAdapter(OverrideActivityAdd.this,nomineeList);
