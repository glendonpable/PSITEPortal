 ...
 */
public class OverrideFragment extends Fragment implements SearchView.OnQueryTextListener{
    ...
    private ArrayList<String> add_emails = new ArrayList<String>();
    private ArrayList<String> remove_emails = new ArrayList<String>();
    ...
    private void insertData(/*final String username*/final ArrayList<String> add_email, final ArrayList<String> remove_email){
        ...
        StringRequest sr = new StringRequest(Request.Method.POST, Config.ROOT_URL + Config.WEB_SERVICES + override, new Response.Listener<String>() {
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                int i = 0;
                int ii= 0;
                for(String object : add_email) {
                    params.put("add_email[" + i + "]", object);
                    Log.wtf("email[" + i + "]", object);
                    i++;
                }
                for(String object : remove_email) {
                    params.put("remove_email[" + ii + "]", object);
...
//                        hidePDialog();
                        ...
                        try {
                            ...
                            for(int i = 0; i < jsonArray.length(); i++) {
                                String imageUrl, name, first_name, last_name, institution, contact, email, address, is_auto_added, is_excluded;
                                ...
                                if(jsonObject.getString("success").equals("0")){
                                    ...
                                    nominee = new Nominee(imageUrl, "", name, institution, contact, email, address, checked, "");

                                    nomineeList.add(nominee);
                                }
                            }
                            adapter = new OverrideAdapter(getActivity(),nomineeList);
